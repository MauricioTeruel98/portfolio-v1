                ...
                <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
                    <li>
                        ...
                        <div className="timeline-end mb-10">
                            <time className="font-mono">Agosto 2024 - Actualidad</time>
                            <div className="text-xl font-black">Desarrollado Web Fullstack</div>
                            <p className='text-lg font-black my-2'>Buzz Agencia Digital</p>
                            <p>
                    ...
                    <li>
                        ...
                        <div className="timeline-start md:text-end mb-10">
                            <time className="font-mono">Marzo 2024 - Octubre 2024</time>
                            <div className="text-xl font-black">Desarrollado Web Fullstack</div>
